      ...
      <main className="flex-1 container py-8">
        ...
        <Tabs defaultValue="government" className="w-full">
          <TabsList className="flex flex-wrap h-auto gap-1 bg-muted/50 p-1 mb-6">
            ...
            <TabsTrigger value="gov-info" className="text-xs sm:text-sm data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">
              <span className="mr-1">🏛️</span>
              <span className="hidden sm:inline">Government Info</span>
              <span className="sm:hidden">Gov Info</span>
            </TabsTrigger>
          </TabsList>
          ...
          {/* Government Info - single tab with nested sub-tabs */}
          <TabsContent value="gov-info">
            <Card className="mb-6 border-primary/20">
              <CardHeader className="pb-3">
                <CardTitle className="text-xl flex items-center gap-2">
                  <span className="text-2xl">🏛️</span> Government Information & India Dashboard
                </CardTitle>
                <p className="text-sm text-muted-foreground">Leaders, Budget, Rankings, Ministries & more</p>
              </CardHeader>
              <CardContent>
                <Tabs defaultValue="leaders" className="w-full">
                  <TabsList className="flex flex-wrap h-auto gap-1 bg-muted/50 p-1 mb-6">
                    <TabsTrigger value="leaders" className="text-xs sm:text-sm">👔 Leaders</TabsTrigger>
                    <TabsTrigger value="cms" className="text-xs sm:text-sm">🏢 State CMs</TabsTrigger>
                    ...
                    <TabsTrigger value="facts" className="text-xs sm:text-sm">📊 India Facts</TabsTrigger>
                    <TabsTrigger value="ministries" className="text-xs sm:text-sm">🏛️ Ministries</TabsTrigger>
                  </TabsList>
